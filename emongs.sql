...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2024 at 07:55 AM
...
CREATE TABLE `denomination` (
  ...
  `denomination_created_at` date NOT NULL DEFAULT current_timestamp()
...
INSERT INTO `denomination` (`denomination_id`, `sales_id`, `am_pm`, `onek`, `fiveh`, `twoh`, `oneh`, `fiftyp`, `twentyp`, `tenp`, `fivep`, `onep`, `denomination_total`, `denomination_created_at`) VALUES
(14, 28, 'AM', 5, 1, 2, 0, 1, 0, 0, 0, 0, 5950, '2024-03-25'),
(15, 29, 'AM', 5, 1, 2, 0, 1, 0, 0, 0, 0, 5950, '2024-03-26'),
(16, 30, 'AM', 5, 1, 1, 1, 1, 0, 1, 1, 0, 5865, '2024-03-27'),
(17, 31, 'AM', 5, 1, 1, 1, 1, 0, 1, 1, 0, 5865, '2024-03-28');
...
CREATE TABLE `sales` (
  ...
  `sales_date_created_at` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sales` (`sales_id`, `product_id`, `am_pm`, `total_plantsa`, `bo`, `gas`, `sales_total`, `rider_commission`, `owner_commission`, `subTotal`, `sales_date_created_at`) VALUES
(28, 1, '', 50, 10, 200, 5950, 476, 416, 5057, '2024-03-25'),
(29, 1, '', 50, 10, 200, 5950, 476, 416, 4858, '2024-03-26'),
(30, 1, '', 50, 27, 0, 5865, 469, 411, 4985, '2024-03-27'),
(31, 1, '', 50, 27, 200, 5865, 469, 411, 4785, '2024-03-28');
